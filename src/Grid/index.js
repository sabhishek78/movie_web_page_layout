...
class Grid extends React.Component{
    constructor(props) {
        ...
        for(let i=0;i<moviesList.length;i++){
            url.push(moviesList[i]['posterurl']);
            title.push(moviesList[i]['title']);
            rating.push(moviesList[i]['contentRating']);
            genre.push(moviesList[i]['genres'][0]);
        }
        for(let i=0;i<moviesList.length;i++){
            squaresList.push(<Square url={url[i]} title={title[i]} genre={genre[i]} rating={rating[i]}/>);
        }
    }
    render() {
        return(
